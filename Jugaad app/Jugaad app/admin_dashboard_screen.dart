...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
            ...
            children: [
              ...
              Expanded(
                child: ListView(
                  padding: const EdgeInsets.all(16.0),
                  children: [
                    _buildWorkerRow('Rajesh K.', 'Laptop, Phone', '0.8 km', true, adminPrimary),
                    const SizedBox(height: 12.0),
                    _buildWorkerRow('Arun M.', 'Laptop', '1.2 km', true, adminPrimary),
                    const SizedBox(height: 12.0),
                    _buildWorkerRow('Suresh V.', 'Laptop, AC', '2.5 km', false, adminPrimary), // Offline
                  ],
                ),
              ),
            ],
  ...
  Widget _buildWorkerRow(String name, String skills, String distance, bool isOnline, Color adminPrimary) {
    return Container(
